<template>
	...
	>
		<DialogContent :include-close-button="false">
			<DialogHeader>
				<DialogTitle>Выберите франчайзи</DialogTitle>
			</DialogHeader>
...
import type { FranchiseeDTO, FranchiseeFilterDTO } from '@/modules/admin/franchisees/models/franchisee.model'
...
const emit = defineEmits<{
  (e: 'close'): void;
  (e: 'select', additive: FranchiseeDTO): void;
}>()
...
function selectMaterial(additive: FranchiseeDTO) {
