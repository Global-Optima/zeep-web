	...
	>
		<div>
			...
			<p class="text-blue-900 text-sm">
				Внесены изменения в продукты, модификатора или технологические карты. Нажмите кнопку ниже
				для обновления.
			</p>
		</div>
		<Button
...
const { mutate: syncData, isPending } = useMutation({
  ...
  onSuccess: () => {
    ...
    toast({
      ...
      description: 'Все изменения в продуктах, модификаторах и технологических картах обновлены.',
      variant: 'success',
    })
  },
  onError: () => {
