...
import AdminNotificationsList from '@/modules/admin/notifications/components/list/admin-notifications-list.vue'
import AdminNotificationsToolbar from '@/modules/admin/notifications/components/list/admin-notifications-toolbar.vue'
import type {
