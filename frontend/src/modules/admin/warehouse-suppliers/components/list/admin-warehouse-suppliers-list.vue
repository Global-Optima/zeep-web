	...
	<Table>
		...
		<TableBody>
			<TableRow
				...
				:key="supplier.id"
				@click="onSupplierClick(supplier.id)"
...
const {suppliers} = defineProps<{suppliers: SupplierDTO[]}>()

const router = useRouter();

const onSupplierClick = (id: number) => {
  router.push(`/admin/warehouse-suppliers/${id}`);
};
</script>
