...
import { STOCK_REQUEST_STATUS_COLOR, STOCK_REQUEST_STATUS_FORMATTED, type StockRequestResponse } from '@/modules/admin/stock-requests/models/stock-requests.model'
...
const goToDetails = (requestId: number) => {
  router.push(`/admin/stock-requests/${requestId}`);
};
</script>
