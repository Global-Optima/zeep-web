...
import type { StockRequestMaterial, StockRequestStockMaterialDTO } from '@/modules/admin/stock-requests/models/stock-requests.model'
...
interface UpdateStockRequestItemForm {
...
const stockRequestItemsForm = ref<UpdateStockRequestItemForm[]>([])
...
function submitForm() {
  ...
  const dto: StockRequestStockMaterialDTO[] = stockRequestItemsForm.value.map(item => ({
