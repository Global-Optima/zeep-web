...
export const FORMATTED_AUDIT_COMPONENTS: Record<EmployeeAuditComponentName, string> = {
	...
	[EmployeeAuditComponentName.ADDITIVE]: 'Модификатор',
	[EmployeeAuditComponentName.ADDITIVE_CATEGORY]: 'Категория модификаторов',
	[EmployeeAuditComponentName.STORE_ADDITIVE]: 'Модификатор в кафе',
	...
	[EmployeeAuditComponentName.INGREDIENT]: 'Сырье',
	[EmployeeAuditComponentName.INGREDIENT_CATEGORY]: 'Категория сырья',
