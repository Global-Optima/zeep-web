...
import type { UpdateEmployeeDto } from '@/modules/employees/models/employees.models'
...
const updateMutation = useMutation({
	mutationFn: (newStoreData: UpdateEmployeeDto) => employeesService.updateEmployee(Number(employeeId), newStoreData),
	onSuccess: () => {
