<template>
	<img
		:src="imageUrl"
		alt="Product Image"
		class="w-full h-[400px] sm:h-[600px] object-cover"
	/>

	<div
		class="absolute inset-0 h-[400px] sm:h-[600px] bg-gradient-to-t to-50% from-[#F5F5F7] to-transparent  pointer-events-none"
	></div>
