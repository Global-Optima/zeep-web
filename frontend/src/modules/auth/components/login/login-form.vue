...
const formSchema = toTypedSchema(
  z.object({
    ...
    selectedEmployeeId: z.coerce.number().min(1, {message: "Пожалуйста, выберите сотрудника"}),
...
const onSubmit = handleSubmit((values) => {
  ...
  loginEmployee({employeeId: values.selectedEmployeeId, password: values.password})
})
</script>
