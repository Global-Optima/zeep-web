...
func getAutogeneratedComments(details []StockRequestDetails) *localization.LocalizedMessage {
	var mismatchComments []localization.LocalizedMessage
	var unexpectedComments []localization.LocalizedMessage
