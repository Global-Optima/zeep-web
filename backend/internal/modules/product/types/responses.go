...
var (
	...
	Response409ProductInUseDelete = localization.NewResponseKey(409, data.ProductComponent, data.DeleteOperation.ToString(), "in_use")
	...
	Response409ProductSizeInUseDelete = localization.NewResponseKey(409, data.ProductSizeComponent, data.DeleteOperation.ToString(), "in_use")
