	...
	if NotificationRoleMappingManagerInstance == nil {
		NotificationRoleMappingManagerInstance = &NotificationRoleMappingManager{
			mappings: []NotificationRoleMapping{
				...
				{
					EventType:     data.NEW_PRODUCT,
					EmployeeRoles: []data.EmployeeRole{data.RoleAdmin, data.RoleFranchiseManager},
				},
				{
					EventType:     data.NEW_PRODUCT_SIZE,
					EmployeeRoles: []data.EmployeeRole{data.RoleAdmin, data.RoleFranchiseManager},
				},
				{
					EventType:     data.NEW_ADDITIVE,
					EmployeeRoles: []data.EmployeeRole{data.RoleAdmin, data.RoleFranchiseManager},
				},
				{
				...
				{
					EventType:     data.STORE_STOCK_EXPIRATION,
					EmployeeRoles: []data.EmployeeRole{data.RoleBarista, data.RoleFranchiseManager, data.RoleStoreManager},
				},
				{
					EventType:     data.STORE_PROVISION_EXPIRATION,
					EmployeeRoles: []data.EmployeeRole{data.RoleBarista, data.RoleStoreManager},
				},
				{
