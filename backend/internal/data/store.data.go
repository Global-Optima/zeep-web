...
type StoreProvision struct {
	...
	Volume                    float64                    `gorm:"type:decimal(10,2);not null" sort:"volume"`
	InitialVolume             float64                    `gorm:"type:decimal(10,2);not null;check:initial_volume > 0" sort:"initialVolume"`
