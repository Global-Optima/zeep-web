...
var (
	...
	enDictionaryFalsePositives = []string{
		"ass",
		"balls",
		"cock",
		"sex",
	...
	enDictionaryFalseNegatives = []string{
		"asshat",
		"asswipe",
		"douchebag",
		"wanker",
	...
	ruDictionaryFalsePositives []string
	ruDictionaryFalseNegatives []string

	kkDictionary               []string
	kkDictionaryFalsePositives []string
	kkDictionaryFalseNegatives []string
)

func InitializeCensor() error {
	enDetector = goaway.NewProfanityDetector().WithCustomDictionary(enDictionary, enDictionaryFalsePositives, enDictionaryFalseNegatives)
	ruDetector = goaway.NewProfanityDetector().WithCustomDictionary(ruDictionary, ruDictionaryFalsePositives, ruDictionaryFalseNegatives)
	kkDetector = goaway.NewProfanityDetector().WithCustomDictionary(kkDictionary, kkDictionaryFalsePositives, kkDictionaryFalseNegatives)

	//TODO load dictionaries from a file
	return nil
}
...
func CensorText(text string) (string, error) {
	...
	censoredText, err := censorWithGoAway(nText)
	if err != nil {
		return "", err
	}
	...
	censoredText, err = censorWithRegex(censoredText, kazakhProfanityRegex)
	if err != nil {
		return "", err
	}
