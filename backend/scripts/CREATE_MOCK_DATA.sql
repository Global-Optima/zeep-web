...
VALUES
    ...
    ('Кофе', 'Горячие кофейные напитки', 'COFFEE'),
    ('Чай', 'Различные виды чая', 'TEA'),
    ('Смузи', 'Фруктовые и овощные смузи', 'TEA'),
    ('Соки', 'Свежевыжатые соки и напитки', 'TEA'),
    (
        'Коктейли',
        'Алкогольные и безалкогольные коктейли', 'TEA'
    ),
    (
        'Газированные напитки',
        'Прохладительные газированные напитки' , 'TEA'
    ),
    (
        'Энергетические напитки',
        'Напитки для повышения энергии', 'TEA'
    ),
    (
        'Молочные коктейли',
        'Коктейли на основе молока и сливок', 'TEA'
    ),
    (
        'Минеральная вода',
        'Природная и газированная минеральная вода', 'TEA'
    ),
    ('Фраппе', 'Кофейные напитки со льдом', 'COFFEE'),
    ('Травяные чаи', 'Настои и чаи на травах', 'TEA'),
    (
        'Круассаны',
        'Свежая выпечка с хрустящей корочкой и разнообразной начинкой — идеально к кофе', 'TEA'
    ),
    (
        'Тестовые продукты',
        'Продукты для тестирования функционала QR-кодов', 'TEA'
    );
