...
INSERT INTO
  employees (id, name, phone, email, role, type, is_active, hashed_password, created_at, updated_at)
VALUES
  ...
  (6, 'Олег Кузнецов', '79991234567', 'oleg@example.com', 'Cleaner', 'store', false, '$2a$10$GEmb44LusyHrWXXaz5BKce5N8CvBvz3lPK7CuNS.S86.Quec12Xgy', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ...
  (8, 'Алексей Попов', '79002221133', 'alexei@example.com', 'Worker', 'warehouse', true, '$2a$10$GEmb44LusyHrWXXaz5BKce5N8CvBvz3lPK7CuNS.S86.Quec12Xgy', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (9, 'Юлия Петрова', '79115555666', 'yulia@example.com', 'Supervisor', 'warehouse', true, '$2a$10$GEmb44LusyHrWXXaz5BKce5N8CvBvz3lPK7CuNS.S86.Quec12Xgy', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (10, 'Дмитрий Фролов', '79553334456', 'dmitry@example.com', 'Cleaner', 'warehouse', true, '$2a$10$GEmb44LusyHrWXXaz5BKce5N8CvBvz3lPK7CuNS.S86.Quec12Xgy', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert into store_employees
INSERT INTO
  store_employees (id, employee_id, store_id, is_franchise, created_at, updated_at)
VALUES
  (1, 1, 1, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 2, 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (3, 3, 1, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (4, 4, 3, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (5, 5, 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (6, 6, 1, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert into warehouse_employees
INSERT INTO
  warehouse_employees (id, employee_id, warehouse_id, created_at, updated_at)
VALUES
  (1, 7, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 8, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (3, 9, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (4, 10, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
