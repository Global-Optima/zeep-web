...
func TestIngredientEndpoints(t *testing.T) {
	...
	t.Run("Create an Ingredient", func(t *testing.T) {
		testCases := []utils.TestCase{
			...
			{
				Description: "Admin should NOT create a new ingredient with empty name",
				Method:      http.MethodPost,
				URL:         "/api/test/ingredients",
				Body: map[string]interface{}{
					"name":             " ",
			...
			{
				Description: "Admin should NOT create a new ingredient with negative fields",
				Method:      http.MethodPost,
				URL:         "/api/test/ingredients",
				Body: map[string]interface{}{
					"name":             "Sugar",
			...
			{
				Description: "Admin should create a new ingredient with no expiration",
				Method:      http.MethodPost,
				URL:         "/api/test/ingredients",
				Body: map[string]interface{}{
					"name":       "Sugar",
	...
	t.Run("Fetch all Ingredients", func(t *testing.T) {
		testCases := []utils.TestCase{
			...
			{
				Description:  "Admin should search ingredients",
				Method:       http.MethodGet,
				URL:          "/api/test/ingredients?search=sugar",
				AuthRole:     data.RoleAdmin,
				ExpectedCode: http.StatusOK,
			},
		}
